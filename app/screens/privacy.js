        ...
        <View style={styles.container}>
          <View style={{ width: widthPercentageToDP(80) }}>
            ...
            <Text style={{ fontSize: 18, padding: 3 }}>
              ...
              you: Download and use our mobile application — Xpiry Engage with
              us in other related ways ― including any sales, marketing, or
              events In this privacy notice, if we refer to: "App," we are
              referring to any application of ours that references or links to
              this policy, including any listed above "Services," we are
              referring to our App, and other related services, including any
              sales, marketing, or events The purpose of this privacy notice is
              ...
              it. If there are any terms in this privacy notice that you do not
            ...
            <Text style={{ fontSize: 18, padding: 3 }}>
              ...
              privacy notice carefully, as it will help you understand what we
            ...
            <Text style={{ fontSize: 18, padding: 3 }}>
              ...
              on the App, express an interest in obtaining information about us
              or our products and Services, when you participate in activities
              on the App or otherwise when you contact us. The personal
              ...
              may include the following: Personal Information Provided by You.
              We collect phone numbers; names; and other similar information.
            ...
            <Text style={{ fontSize: 18, padding: 3 }}>
              ...
              device, push notifications, when you use our App. If you use our
              App, we also collect the following information: Mobile Device
              Access. We may request access or permission to certain features
              from your mobile device, including your mobile device's camera,
              calendar, sms messages, reminders, and other features. If you wish
              to change our access or permissions, you may do so in your
              device's settings. Push Notifications. We may request to send you
