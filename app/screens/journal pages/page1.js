  ...
  <View>
    <Text style={[styles.title ]}>Tips on Medicine Intake</Text>
            <Text style={[styles.link]} onPress={() => Linking.openURL('https://www.fda.gov/drugs/special-features/why-you-need-take-your-medications-prescribed-or-instructed')}>Click Here for More Information</Text>        
                ...
                <Unorderedlist bulletUnicode={0x2023} style={[styles.bullet]}><Text style={[styles.content]}>Double-check that you have the right medicine. If you get the same prescription filled more than once, check that it's the same shape, size, and color as the last time. If not, be sure to ask the pharmacist about it.</Text></Unorderedlist>
